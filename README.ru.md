...
Делаю веб-приложения целиком — от базы данных и API до интерфейса, с которым работают люди, — и люблю, когда результат быстрый, покрыт тестами и легко поддерживается.

### 🚀 Обо мне

- 🧩 Full-stack разработчик: на бэкенде в основном **PHP / Laravel**, на фронтенде — **Vue / Nuxt**
- 🤖 Делаю бизнес-приложения, админ-панели и Telegram-ботов
- 🐳 Довожу проекты до продакшена с Docker, Nginx и CI-пайплайнами
- 🧪 Ценю тесты, статический анализ и чистый код
- 🌟 Автор open-source библиотеки [htmldocx](https://github.com/Kovami/htmldocx)
...
**[kovami/htmldocx](https://github.com/Kovami/htmldocx)** — PHP-библиотека без зависимостей, которая конвертирует HTML в Word (DOCX) и обратно: списки, таблицы, изображения, сноски, колонтитулы, комментарии и формулы.
